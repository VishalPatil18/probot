...
<Note>
  Want the chat served from your own domain instead? You can self-host your bot
  with the tiny `probot-bot` runtime - see [Self-hosting your
  bot](/self-hosted-bot/index).
</Note>
