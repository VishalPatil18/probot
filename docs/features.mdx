...
- **Managed** hosting (zero ops) or a **self-hosted bot** via the [`probot-self-hosted`](https://www.npmjs.com/package/probot-self-hosted) npm package inside your own web app. [Guide](/guides/deployment)
- **Bot tokens + versioned API** for self-hosted bot analytics. [Reference](/self-hosted-bot/api-reference)
