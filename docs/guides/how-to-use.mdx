...
ProBot is bring-your-own-key: you supply a key for Claude, OpenAI, Azure, or Gemini. It's envelope-encrypted at rest, never logged in plaintext, and never billed by us. See [Models & keys](/guides/models-and-keys).
