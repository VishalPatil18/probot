...
<Note>
  **Want it truly $0?** Google Gemini's free tier is the zero-cost path -
  grab a key at [aistudio.google.com](https://aistudio.google.com/app/apikey).
  **Grok**, by contrast, uses xAI's paid API - it's free to *operate* (you
  bring your own key) but xAI bills you for usage.
</Note>
