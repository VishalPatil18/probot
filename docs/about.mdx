...
ProBot uses retrieval-augmented generation (RAG): your data is chunked, embedded into a private vector store, and the most relevant pieces are handed to your chosen LLM with strict instructions to cite, not invent. Your key never leaves your browser; your data never leaves your account.

## Four rules we don't break

1. **You own the keys.** Your LLM key lives in your browser. The server never sees it.
