...
- **Self-hosted:** wherever you deployed (see [Self-host](/guides/self-host))
...
NextAuth's `/api/auth/[...nextauth]` is **not** documented here - its surface is owned by NextAuth and changes per their docs. See <https://next-auth.js.org/getting-started/rest-api>.
