...
<p align="justify">
  **And for the security-conscious, you can self-host the bot:** If you'd rather
  not trust any operator with your setup, install the `probot-self-hosted` npm
  package in your own web app - the whole bot runs there, your LLM key stays in
  your backend, and pro-bot.dev only sees the analytics you opt into.
</p>
